...
class PostAccountUsageBillingRateAdjustmentRequest(object):
    ...
    def billing_cost(self, billing_cost):
        ...
        if (self.local_vars_configuration.client_side_validation and
                billing_cost is not None and billing_cost < 0):  # noqa: E501
            raise ValueError("Invalid value for `billing_cost`, must be a value greater than or equal to `0`")  # noqa: E501
