...
class PatchBusinessRequest(object):
    ...
    @property
    def name(self):
        """Gets the name of this PatchBusinessRequest.  # noqa: E501

        I am curious to see if this works with markdown like this link: [to google](https://www.google.com)  # noqa: E501

        :return: The name of this PatchBusinessRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this PatchBusinessRequest.

        I am curious to see if this works with markdown like this link: [to google](https://www.google.com)  # noqa: E501

        :param name: The name of this PatchBusinessRequest.  # noqa: E501
        :type name: str
        """
