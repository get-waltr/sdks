...
export interface AccountResponse {
     ...
     * @memberof AccountResponse
     */
    'remainingHoursOnBalance'?: number;
}
/**
 * 
 * @export
...
export interface AllAccountsResponse {
    /**
     * 
     * @type {AllAccountsResponseAccounts}
     * @memberof AllAccountsResponse
     */
    'accounts': AllAccountsResponseAccounts;
    /**
     * 
     * @type {number}
     * @memberof AllAccountsResponse
 ...
 * 
 * @export
 * @interface AllAccountsResponseAccounts
 */
export interface AllAccountsResponseAccounts {
    /**
     * 
     * @type {Array<AccountResponse>}
     * @memberof AllAccountsResponseAccounts
     */
...
export interface AllTransactionsResponse {
    /**
     * 
     * @type {AllTransactionsResponseTransactions}
 ...
 * 
 * @export
 * @interface AllTransactionsResponseTransactions
 */
export interface AllTransactionsResponseTransactions {
    /**
     * 
     * @type {Array<TransactionResponse>}
     * @memberof AllTransactionsResponseTransactions
     */
...
export const AccountsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        accountsAccountIdPatch: async (patchAccountRequest: PatchAccountRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarHeaderParameter['Content-Type'] = 'application/json; charset=utf8';
...
export const BusinessesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        businessesBusinessIdSettingsGet: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const BusinessesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async businessesBusinessIdSettingsGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BusinessSettingsResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.businessesBusinessIdSettingsGet(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const BusinessesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        businessesBusinessIdSettingsGet(options?: any): AxiosPromise<BusinessSettingsResponse> {
            return localVarFp.businessesBusinessIdSettingsGet(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class BusinessesApi extends BaseAPI {
     ...
     * @memberof BusinessesApi
     */
    public businessesBusinessIdSettingsGet(options?: AxiosRequestConfig) {
        return BusinessesApiFp(this.configuration).businessesBusinessIdSettingsGet(options).then((request) => request(this.axios, this.basePath));
    }
}
