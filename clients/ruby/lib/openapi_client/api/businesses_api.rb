...
module OpenapiClient
  class BusinessesApi
    ...
    def businesses_business_id_get_with_http_info(opts = {})
      ...
      header_params['Accept'] = @api_client.select_header_accept(['application/json; charset=utf8'])
    ...
    def businesses_business_id_patch_with_http_info(patch_business_request, opts = {})
      ...
      content_type = @api_client.select_header_content_type(['application/json; charset=utf8'])
      if !content_type.nil?
    ...
    def businesses_business_id_settings_get(opts = {})
      data, _status_code, _headers = businesses_business_id_settings_get_with_http_info(opts)
      data
    end
    ...
    def businesses_business_id_settings_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: BusinessesApi.businesses_business_id_settings_get ...'
      end
      # resource path
      local_var_path = '/businesses/:businessId/settings'
      ...
      new_options = opts.merge(
        :operation => :"BusinessesApi.businesses_business_id_settings_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BusinessesApi#businesses_business_id_settings_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
