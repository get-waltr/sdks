...
/**
 * PatchTransactionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchTransactionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchTransactionRequest';
    ...
    */
    ...
    public function setAccountId($account_id)
    {
        ...
        if (!is_null($account_id) && (mb_strlen($account_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling PatchTransactionRequest., must be bigger than or equal to 1.');
        }
