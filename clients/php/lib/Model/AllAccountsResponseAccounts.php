...
/**
 * AllAccountsResponseAccounts Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AllAccountsResponseAccounts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AllAccountsResponse_accounts';
    ...
    protected static $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\AccountResponse[]',
        'count' => 'float',
        'scanned_count' => 'float',
    ...
    */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\AccountResponse[] $items items
     *
     * @return self
     */
